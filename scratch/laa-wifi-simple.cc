...
static ns3::GlobalValue g_lbtTxop ("lbtTxop",
                                   "TxOp for LBT devices (ms)",
                                   ns3::DoubleValue (8.0),
                                   ns3::MakeDoubleChecker<double> (2.0, 20.0));
...
{  
  ...
  switch (channelAccessManager)
    ...
    case Lbt:
      ...
      Config::SetDefault ("ns3::LbtAccessManager::DeferTime",Seconds ((16.0+9.0*laaDeferX)/1000000.0));
      Config::SetDefault ("ns3::LbtAccessManager::MinCw",static_cast<uint32_t>(laaMinCw));
      Config::SetDefault ("ns3::LbtAccessManager::MaxCw",static_cast<uint32_t>(laaMinCw*(1<<laaMaxM)));
      break;
    case DutyCycle:
