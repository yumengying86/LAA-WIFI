...
EdcaTxopN::SetupBlockAckIfNeeded ()
{
  ...
  // ns-3 bug 2471 on disabling block ack-- workaround applied here
  // and also the thresholds raised to 2 packets for the access categories 
  // AC_BK, AC_BE, and AC_VI (but not AC_VO) in the LAA examples
