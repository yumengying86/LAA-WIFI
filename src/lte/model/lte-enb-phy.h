...
private:
  ...
  */
  ...
  bool m_drsReservationSignal; // we need this variables to distinguish when reservation signal is real reservation signal and when is used to simulate long DRS transmission
